...
int create_gcode(const char *tmpdir, const char *ofilename)
{
    ...
    fprintf(f, ";(X Resolution            = 1410 )\n");
    fprintf(f, ";(Y Resolution            = 2531 )\n");
    fprintf(f, ";(Layer Thickness         = 0.05000 mm )\n");
    fprintf(f, ";(Layer Time              = 10000 ms )\n");
    fprintf(f, ";(Render Outlines         = False\n");
    fprintf(f, ";(Outline Width Inset     = 2\n");
    fprintf(f, ";(Outline Width Outset    = 0\n");
    fprintf(f, ";(Bottom Layers Time      = 30000 ms )\n");
    fprintf(f, ";(Number of Bottom Layers = 3 )\n");
    fprintf(f, ";(Blanking Layer Time     = 0 ms )\n");
    fprintf(f, ";(Build Direction         = Bottom_Up)\n");
    fprintf(f, ";(Lift Distance           = 4 mm )\n");
    ...
    fprintf(f, ";(Z Lift Feed Rate        = 100.0 mm/s )\n");
    fprintf(f, ";(Z Bottom Lift Feed Rate = 100.0 mm/s )\n");
    fprintf(f, ";(Z Lift Retract Rate     = 100.0 mm/s )\n");
    fprintf(f, ";(Flip X                  = True)\n");
    fprintf(f, ";(Flip Y                  = True)\n");
    fprintf(f, ";Number of Slices         = 130\n");
    fprintf(f, ";(****Machine Configuration ******)\n");
    fprintf(f, ";(Platform X Size         = 65.02mm )\n");
    fprintf(f, ";(Platform Y Size         = 116mm )\n");
    fprintf(f, ";(Platform Z Size         = 130mm )\n");
